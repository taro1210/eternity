...
画面に適切な文言を表示する（表示例、[獲得したチップ30枚でBig or Smallを続けますか？]: 0:Yes 1:No ）。
...
12．上記の9で「Big or Smallを続けますか？」について「No」を選択した場合、あるいは「Big or Small」に外れた場合は、「Big or Small」ゲームを続けるかどうか選択する。 画面に適切な文言を表示する（表示メッセージの例は以下画像を参照）。 Yes or No の選択を画面から入力できる 。
